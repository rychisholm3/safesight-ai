...
from src.pipeline.sources import FileSource, WebcamSource, RTSPSource, SourceInfo, open_source
...
class TestFileSource:
    @patch("src.pipeline.sources.cv2.VideoCapture")
...
class TestRTSPSource:
    @patch("src.pipeline.sources.time.sleep")
    @patch("src.pipeline.sources.cv2.VideoCapture")
